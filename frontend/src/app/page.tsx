    ...
    <main className="min-h-screen bg-[#F4F4F4] pb-14 md:pb-0">
      ...
      <div className="max-w-[1280px] mx-auto px-4 py-4 space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <a href="/auth" className="group bg-gray-950 px-6 py-5 text-white hover:bg-gray-800 transition-colors flex items-center justify-between">
            <div>
              ...
              <div className="text-sm text-gray-400 mt-1">가입 즉시 3,000원 쿠폰 지급</div>
            </div>
