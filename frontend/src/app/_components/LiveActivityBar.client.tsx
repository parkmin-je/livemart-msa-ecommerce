        ...
        <div className="flex items-center justify-between py-3 gap-4 overflow-x-auto no-scrollbar">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            <span className="relative flex items-center justify-center w-2 h-2">
              <span className={`relative z-10 w-2 h-2 rounded-full ${isLive ? 'bg-red-500' : 'bg-gray-400'}`} />
              {isLive && (
          ...
          <div className="flex items-center gap-6 flex-1 justify-center flex-wrap">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[11px] text-gray-500">현재 접속</span>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[11px] text-gray-500">오늘 주문</span>
              <span className="text-[12px] font-black tabular-nums" style={{ color: '#0E0E0E' }}>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[11px] text-gray-500">오늘 매출</span>
            ...
            {metrics.topProducts && metrics.topProducts[0] && (
              <>
                ...
                <div className="items-center gap-2 hidden sm:flex">
                  ...
                  <span className="text-[11px] text-gray-500">인기</span>
